...
pub use self::selective::{
    ...
    SelectiveTreeRequest, SelectiveTreeTopology, create_primitive_selective_tree_geometry,
    create_primitive_selective_tree_geometry_from_spec, create_selective_tree_geometry,
};
