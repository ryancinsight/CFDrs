//! Figure-8 (weave) path generation for center trifurcation channels.

use super::ArcChannelStrategy;
...
impl ArcChannelStrategy {
    ...
    pub(super) fn is_center_trifurcation_channel(
        &self,
        p1: Point2D,
        p2: Point2D,
        box_dims: (f64, f64),
    ...
    pub(super) fn generate_figure_eight_path(
        &self,
        p1: Point2D,
        p2: Point2D,
        geometry_config: &GeometryConfig,
