...
mod tests {
    ...
    fn test_module_imports() {
        ...
        let spectral_config: SpectralConfig<f64> = SpectralConfig::new(8, 8, 8).expect("Failed to create spectral config");
    ...
    fn test_spectral_solver_creation() {
        let config: SpectralConfig<f64> = SpectralConfig::new(4, 4, 4).expect("Failed to create config");
    ...
    fn test_chebyshev_polynomial_operations() {
        ...
        let poly: ChebyshevPolynomial<f64> = ChebyshevPolynomial::new(5).expect("Failed to create Chebyshev polynomial");
    ...
    fn test_fourier_transform_accuracy() {
        ...
        let ft: FourierTransform<f64> = FourierTransform::new(8).expect("Failed to create Fourier transform");
    ...
    fn test_vof_solver_creation() {
        ...
        let solver: crate::vof::VofSolver<f64> = crate::vof::VofSolver::create(config, nx, ny, nz, dx, dy, dz);
    ...
    fn test_chebyshev_collocation_properties() {
        ...
        let poly: ChebyshevPolynomial<f64> = ChebyshevPolynomial::new(6).expect("Failed to create polynomial");
        ...
        let d2_matrix = poly.second_derivative_matrix().expect("Failed to create second derivative matrix");
