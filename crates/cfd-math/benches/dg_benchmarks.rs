            ...
            c.bench_function(
                ...
                |b| {
                    ...
                    let dg_op = DGOperator::new(order, 1, Some(params))
                        .expect("invariant: DG benchmark operator dimensions are valid");
                    let u0 = |x: f64| {
                        Array1::from_shape_vec([1], vec![x])
                            .expect("invariant: DG benchmark state has one component")
                    };
                    ...
                    solver
                        .initialize(u0)
                        .expect("invariant: DG benchmark initial state matches operator");
                    ...
                    b.iter(|| {
                        ...
                        solver
                            ...
                            .expect("invariant: DG benchmark step accepts manufactured RHS");
                    });
                },
            );
        }
        ...
        for &num_elements in &num_elements_list {
            c.bench_function(
                ...
                |b| {
                    ...
                    let u0 = |x: f64| {
                        Array1::from_shape_vec([1], vec![0.5 + x])
                            .expect("invariant: DG benchmark state has one component")
                    };
