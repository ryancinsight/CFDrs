...
mod tests {
    ...
    fn test_etd1_simple() {
        ...
        let result = etd
            .etd1(&u0, &matrix, &rhs, dt)
            .expect("invariant: ETD1 accepts scalar decay state");
    ...
    fn test_etd1_phi_source_term() {
        ...
        let result = etd
            .etd1(&u0, &matrix, &rhs, dt)
            .expect("invariant: ETD1 accepts scalar source state");
    ...
    fn test_erk4_simple() {
        ...
        let result = erk4
            .step(&u0, rhs, dt)
            .expect("invariant: exponential RK4 accepts scalar decay state");
