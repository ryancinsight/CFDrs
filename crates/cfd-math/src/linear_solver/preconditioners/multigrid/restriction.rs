...
mod tests {
    ...
    fn create_test_interpolation() -> RestrictionMatrix {
        ...
        *interpolation
            .get_mut([0, 0])
            .expect("invariant: interpolation coordinate is in bounds") = 1.0; // C-point
        *interpolation
            .get_mut([1, 0])
            .expect("invariant: interpolation coordinate is in bounds") = 0.5; // F-point interpolated from C0
        *interpolation
            .get_mut([1, 1])
            .expect("invariant: interpolation coordinate is in bounds") = 0.5; // F-point interpolated from C1
        *interpolation
            .get_mut([2, 1])
            .expect("invariant: interpolation coordinate is in bounds") = 1.0; // C-point
        *interpolation
            .get_mut([3, 1])
            .expect("invariant: interpolation coordinate is in bounds") = 0.3; // F-point
        *interpolation
            .get_mut([3, 2])
            .expect("invariant: interpolation coordinate is in bounds") = 0.7; // F-point
        *interpolation
            .get_mut([4, 2])
            .expect("invariant: interpolation coordinate is in bounds") = 1.0; // C-point
