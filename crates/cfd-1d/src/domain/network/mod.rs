...
pub use builder::{NetworkBuilder, apply_blueprint_boundary_conditions, network_from_blueprint};
...
pub use wrapper::{
    ...
    EDGE_PROPERTY_LOCAL_HEMATOCRIT, EDGE_PROPERTY_PLASMA_VISCOSITY_PA_S, EdgeProperties,
    EdgeWithProperties, Network, ParallelEdge, ResistanceUpdatePolicy,
