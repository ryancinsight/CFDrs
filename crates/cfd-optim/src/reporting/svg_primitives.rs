...
pub(super) fn svg_start(svg: &mut String, width: f64, height: f64) {
    let _ = write!(
        svg,
...
pub(super) fn svg_end(svg: &mut String) {
    svg.push_str("</svg>");
}

pub(super) fn svg_title(svg: &mut String, title: &str) {
    let _ = write!(
        svg,
...
pub(super) fn axis(svg: &mut String, x0: f64, y0: f64, xw: f64, yh: f64) {
    let _ = write!(
        svg,
