...
impl PrimitiveSpec {
    ...
    pub fn build(&self) -> Result<IndexedMesh<f64>, PrimitiveError> {
        use cfd_mesh::domain::geometry::primitives::{
            Capsule, Cone, Cube, Cylinder, Elbow, Ellipsoid, Frustum, GeodesicSphere, Pipe,
            PrimitiveMesh, RoundedCube, Torus, UvSphere,
        };
        use nalgebra::Point3;
        ...
        match self {
            ...
            Self::Capsule {
                ...
                segments: *segments,
                hemisphere_stacks: *hemisphere_stacks,
            })
            .build(),
            Self::Frustum {
                bottom_radius,
            ...
            .build(),
            Self::GeodesicSphere { radius, frequency } => (GeodesicSphere {
                center: origin,
                radius: *radius,
                frequency: *frequency,
            })
