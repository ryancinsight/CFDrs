...
fn rectangular_bifurcation_blueprint(
    ...
    bp.add_channel(ChannelSpec {
        ...
        length_m: aequitas::systems::si::quantities::Length::from_base(parent_length_m),
        cross_section: rectangular_section(parent_width_m),
        channel_shape: ChannelShape::Straight,
        resistance: aequitas::systems::si::quantities::HydraulicResistance::from_base(0.0),
    ...
    bp.add_channel(ChannelSpec {
        ...
        length_m: aequitas::systems::si::quantities::Length::from_base(daughter_length_m),
