...
use cfd_validation::analytical::{AnalyticalSolution, TaylorGreenVortex, CouetteFlow};
...
fn test_taylor_green_energy_decay() {
    ...
    for t in test_times {
        ...
        assert!(energy < prev_energy || t == 0.0, 
            "Energy should decay: E({}) = {} > E(prev) = {}", t, energy, prev_energy);
    ...
    assert!(energy_final < energy_initial, 
        "Energy should have decayed: E(1.0) = {} >= E(0) = {}", energy_final, energy_initial);
}
...
fn test_taylor_green_vorticity_decay() {
    ...
    for i in 0..5 {
        ...
        assert!(
            ...
            t, vorticity_mag, prev_vorticity_mag
        );
