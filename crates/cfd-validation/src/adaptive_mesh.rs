...
impl AdaptiveMeshRefinement {
    ...
    fn compute_sophisticated_error_estimate(
    ...
    fn compute_feature_based_indicator(
        solution: &DMatrix<f64>,
        i: usize,
        j: usize,
        feature_name: &str,
    ...
    fn compute_vorticity_indicator(solution: &DMatrix<f64>, i: usize, j: usize) -> f64 {
        let (nx, ny) = solution.shape();
    ...
    fn compute_discontinuity_indicator(solution: &DMatrix<f64>, i: usize, j: usize) -> f64 {
        let (nx, ny) = solution.shape();
    ...
    fn compute_physics_based_indicator(
        solution: &DMatrix<f64>,
        i: usize,
        j: usize,
