...
impl<T: CfdScalar + std::fmt::LowerExp> TrifurcationFlow<T>
where
    T: FloatElement,
{
    ...
    pub fn new(width: T, length: T, angle: T) -> Self {
        ...
        let murray_factor = <T as FloatElement>::from_f64(0.69336127435);
...
impl<T: CfdScalar + std::fmt::LowerExp> Benchmark<T> for TrifurcationFlow<T>
where
    T: FloatElement,
{
    fn name(&self) -> &str {
