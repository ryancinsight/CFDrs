...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let schematic_path = format!("{out}/serpentine_schematic.png");
    ...
    println!("  Well-mixed:       {}", if mixing_frac_analytical > 0.9 { "YES ✅" } else { "NO ❌" });
    ...
    let overlay_path = format!("{out}/serpentine_mixing_overlay.png");
