...
pub(crate) struct Channel2dEntry<T: CfdScalar + EunomiaRealField + Copy + FloatElement> {
    pub(crate) id: String,
...
pub struct Network2DSolver<T: CfdScalar + EunomiaRealField + Copy + FloatElement> {
