...
mod tests {
    ...
    fn separating_streamline_poiseuille_exact() {
        ...
        let y_sep_50 = ZweifachFung2D::separating_streamline_y(&y_coords, &u_vel, 0.5)
        ...
        let y_sep_100 = ZweifachFung2D::separating_streamline_y(&y_coords, &u_vel, 1.0)
            .expect("invariant: test fixture operation succeeds");
        assert!(
        ...
        let y_sep_0 = ZweifachFung2D::separating_streamline_y(&y_coords, &u_vel, 0.0)
            .expect("invariant: test fixture operation succeeds");
        assert!(
    ...
    fn separating_streamline_linear_profile_closed_form() {
        ...
        let y_sep = ZweifachFung2D::separating_streamline_y(&y_coords, &u_vel, 0.25)
            .expect("invariant: test fixture operation succeeds");
