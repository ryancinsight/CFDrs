...
//!
//! The BSP splitting phase inserts new intersection vertices into the shared
...
mod tests {
    ...
    fn degenerate_face_skipped() {
        ...
        assert_eq!(mesh.face_count(), 0, "degenerate face should be silently skipped");
    }
    ...
    fn shared_vertex_deduplication() {
        ...
        assert_eq!(mesh.vertex_count(), 4, "shared vertices should not be duplicated");
