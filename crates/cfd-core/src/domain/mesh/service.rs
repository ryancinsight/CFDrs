//! Mesh operations service for coordinating mesh-related tasks
//!
//! This service provides a high-level API for generating, refining, and
...
impl<T: RealField + Copy> MeshOperationsService<T> {
    ...
    /// Generate and validate a structured mesh
