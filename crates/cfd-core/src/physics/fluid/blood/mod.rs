...
mod tests {
    ...
    fn test_fluid_trait_implementations() {
        ...
        let casson_state = casson
            ...
            .expect("invariant: normal Casson blood state is valid");
        let carreau_state = carreau
            .properties_at(310.0, 101325.0)
            .expect("invariant: normal Carreau-Yasuda blood state is valid");
        let cross_state = cross_blood
            .properties_at(310.0, 101325.0)
            .expect("invariant: normal Cross blood state is valid");
