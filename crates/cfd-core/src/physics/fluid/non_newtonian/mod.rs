...
mod tests {
    ...
    fn test_herschel_bulkley_constant() {
        ...
        let props = fluid
            .properties_at(300.0, 101325.0)
            .expect("invariant: Herschel-Bulkley state is valid");
    ...
    fn test_herschel_bulkley_temperature_dependent() {
        ...
        let props_ref = fluid
            .properties_at(t_ref, 101325.0)
            .expect("invariant: reference Herschel-Bulkley state is valid");
        assert_relative_eq!(
        ...
        let t_high = 350.0;
        let props_high = fluid
            .properties_at(t_high, 101325.0)
            .expect("invariant: high-temperature Herschel-Bulkley state is valid");
    ...
    fn test_power_law_constant() {
        ...
        let props = fluid
            .properties_at(300.0, 101325.0)
            .expect("invariant: constant Power-Law state is valid");
    ...
    fn test_power_law_temperature_dependent() {
        ...
        let props_ref = fluid
            .properties_at(t_ref, 101325.0)
            .expect("invariant: reference Power-Law state is valid");
        assert_relative_eq!(props_ref.dynamic_viscosity.into_base(), 1.5811388300841898);

        let t_high = 350.0;
        let props_high = fluid
            .properties_at(t_high, 101325.0)
            .expect("invariant: high-temperature Power-Law state is valid");
