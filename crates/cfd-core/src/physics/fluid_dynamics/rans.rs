...
impl<T: RealField + Copy + FromPrimitive> KEpsilonConstants<T> {
    ...
    pub fn standard() -> Self {
        Self {
            c_mu: T::from_f64(crate::physics::constants::physics::turbulence::K_EPSILON_C_MU)
                .unwrap_or_else(T::one),
            c_1: T::from_f64(crate::physics::constants::physics::turbulence::K_EPSILON_C1)
                .unwrap_or_else(T::one),
            c_2: T::from_f64(crate::physics::constants::physics::turbulence::K_EPSILON_C2)
                .unwrap_or_else(T::one),
            sigma_k: T::from_f64(crate::physics::constants::physics::turbulence::K_EPSILON_SIGMA_K)
                .unwrap_or_else(T::one),
            sigma_epsilon: T::from_f64(
                crate::physics::constants::physics::turbulence::K_EPSILON_SIGMA_EPSILON,
            )
            .unwrap_or_else(T::one),
        }
    }
