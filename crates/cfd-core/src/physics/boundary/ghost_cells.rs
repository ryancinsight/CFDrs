...
mod tests {
    ...
    fn test_dirichlet_ghost_cells() {
        ...
        calc.apply_dirichlet(0.0, &interior, &mut ghost).expect("expected value");
    ...
    fn test_neumann_ghost_cells() {
        ...
        calc.apply_neumann(0.0, 0.1, &interior, &mut ghost).expect("expected value");
    ...
    fn fourth_order_dirichlet_uses_quadratic_and_second_ghost_formula() {
        ...
        calc.apply_dirichlet(0.5, &interior, &mut ghost).expect("expected value");
