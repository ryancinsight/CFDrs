...
mod tests {
    ...
    fn test_dirichlet_ghost_cells() {
        ...
        calc.apply_dirichlet(0.0, &interior, &mut ghost)
            .expect("invariant: second-order Dirichlet data is valid");
    ...
    fn test_neumann_ghost_cells() {
        ...
        calc.apply_neumann(0.0, 0.1, &interior, &mut ghost)
            .expect("invariant: second-order Neumann data is valid");
    ...
    fn fourth_order_dirichlet_uses_quadratic_and_second_ghost_formula() {
        ...
        calc.apply_dirichlet(0.5, &interior, &mut ghost)
            .expect("invariant: fourth-order Dirichlet data is valid");
    ...
    fn fourth_order_neumann_uses_high_order_gradient_formula() {
        ...
        calc.apply_neumann(3.0, 0.25, &interior, &mut ghost)
            .expect("invariant: fourth-order Neumann data is valid");
    ...
    fn robin_rejects_degenerate_coefficients() {
        ...
        let err = calc
            ...
            .expect_err("invariant: degenerate Robin coefficients are rejected");
