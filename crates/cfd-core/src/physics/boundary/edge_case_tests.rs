...
mod boundary_edge_cases {
    ...
    fn test_dirichlet_zero_value() {
        ...
        applicator.apply(&mut field, &spec, 0.0).expect("expected value");
    ...
    fn test_boundary_idempotence() {
        ...
        // Apply once
        applicator.apply(&mut field1, &spec, 0.0).expect("expected value");

        // Apply twice
        applicator.apply(&mut field2, &spec, 0.0).expect("expected value");
        applicator.apply(&mut field2, &spec, 0.0).expect("expected value");
