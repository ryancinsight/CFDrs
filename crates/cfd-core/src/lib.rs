...
pub mod plugins {
    pub use crate::plugin::{
        PluginRegistry, PluginLifecycle, PluginCapabilities, 
        PluginValidation, PluginHealth, PluginHealthStatus, 
        PluginMetrics, PluginMonitoring, SystemHealthReport, 
        SystemStatus, ComprehensiveHealthReport, PluginHealthReport
    };
}
