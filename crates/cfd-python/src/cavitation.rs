//! Cavitation physics model wrappers for `PyO3`
...
/// Rayleigh-Plesset bubble dynamics model wrapper
...
impl Default for PyRayleighPlesset {
    fn default() -> Self {
        PyRayleighPlesset {
            inner: RustRayleighPlesset {
...
/// Cavitation regime classifier wrapper
