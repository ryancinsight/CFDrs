//! Standalone Hydrodynamic Cavitation Demonstration
//!
//! This example demonstrates CFDrs cavitation analysis capabilities
//! without depending on the complex validation infrastructure.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  Convergent angle: {:.1}°", convergent_angle * 180.0 / std::f64::consts::PI);
    println!("  Divergent angle: {:.1}°", divergent_angle * 180.0 / std::f64::consts::PI);
    println!();
