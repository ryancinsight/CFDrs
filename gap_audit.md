...
closed by MET-11. A follow-up scan still finds raw network edge area and
generic channel cross-section fields outside these two component slices; those
are the next audit boundary and are not silently classified as closed.
