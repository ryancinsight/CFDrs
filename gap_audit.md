...
unclassified provider-boundary gap. A fresh source scan after MET-10 also
identified public component geometry and network channel-property contracts
that still store lengths, areas, volumes, and roughness as raw scalars; those
remain the next implementation slice and are not silently closed here.
