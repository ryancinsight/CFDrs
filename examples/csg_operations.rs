...
fn boolean_operations() -> Result<(), CsgError> {
    ...
    println!(
        ...
        difference_result.vertex_count(),
        difference_result.face_count()
    );
    ...
    println!(
        ...
        intersection_result.vertex_count(),
        intersection_result.face_count()
    );
    ...
    println!(
        "   ✓ XOR: {} vertices, {} faces",
        xor_result.vertex_count(),
        xor_result.face_count()
    );
...
fn complex_geometry() -> Result<(), CsgError> {
    ...
    println!(
        "   ✓ Complex part: {} vertices, {} faces",
        complex_part.vertex_count(),
        complex_part.face_count()
    );
...
fn cfd_geometries() -> Result<(), CsgError> {
    ...
    println!(
        "   ✓ Flow around cylinder: {} vertices, {} faces",
        flow_around_cylinder.vertex_count(),
        flow_around_cylinder.face_count()
    );
    ...
    println!(
        "   ✓ Pipe with elbow: {} vertices, {} faces",
        pipe_elbow.vertex_count(),
        pipe_elbow.face_count()
    );
    ...
    println!(
        "   ✓ Heat exchanger fin: {} vertices, {} faces",
        fin_geometry.vertex_count(),
        fin_geometry.face_count()
    );
