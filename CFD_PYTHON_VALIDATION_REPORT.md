# cfd-python API Validation Report
...
Comprehensive validation of cfd-python Python bindings revealed:
...
**File:** `crates/cfd-python/src/solver_3d.rs` (lines 333-346)
...
**Results:**
```python
solver = cfd-python.Poiseuille3DSolver(D, L, 20, 16, 30)
...
```python
carreau = cfd-python.CarreauYasudaBlood()
...
```python
solver = cfd-python.Poiseuille3DSolver(D, L, nr, ntheta, nz)
...
**Test Attempt:**
```python
bifurcation = cfd-python.BifurcationSolver(200e-6, 140e-6, 5e-3, 5e-3)
...
**Test Result:**
```python
serpentine = cfd-python.SerpentineSolver1D(100e-6, 500e-6, 200e-6, 10)
...
**Validation Suite:** validation/validate_cfd-python_working.py  
**Analysis Scripts:** validation/verify_newtonian_blood.py  
**Source Code:** crates/cfd-python/src/solver_3d.rs
